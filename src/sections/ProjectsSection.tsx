...
const projects = [
  ...
  },
  {
    ...
    desc: 'Collaborative task management with real-time updates, drag-and-drop, and team features.',
  ...
  },
  {
    ...
    desc: 'Real-time weather app with location tracking, forecasts, and beautiful weather visualizations.',
    tech: ['Vue.js', 'OpenWeather API', 'Chart.js'],
    img: 'https://images.unsplash.com/photo-1592210454359-9043f067919b?auto=format&fit=crop&w=800&q=80',
    github: '#',
    demo: '#',
  },
];
