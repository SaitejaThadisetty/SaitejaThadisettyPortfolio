...
const AboutSection: React.FC = () => (
  <section id="about" className="min-h-[60vh] flex items-center justify-center text-white px-4 md:px-8" >
    <motion.div
      initial={{ opacity: 0, y: 40 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true, amount: 0.5 }}
      transition={{ duration: 0.8 }}
      className="backdrop-blur-md bg-slate-800/30 border border-slate-600/30 rounded-2xl shadow-xl p-8 md:p-12 max-w-2xl mx-auto text-center"
    >
